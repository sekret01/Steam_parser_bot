...
class PriceLooker:
    ...
    def get_discount_info(self) -> tuple[str, str, str]:
        ...
        return origin_price, discount_price, discount_info
    ...
    def get_price_info(self, page: Response) -> tuple[int, str, any]:
        ...
        if self.is_discount():
            discount = 1
            origin_price, discount_price, discount_info = self.get_discount_info()
            discount_data = (discount_price, discount_info)
        else:
            discount = 0
